...
> 完整教科书版见 [[专栏/后端/JVM]]（299 行：内存区域 / 类加载 / 对象布局 / GC 算法 / 收集器 / 调参 / OOM 排查）

## 高频问法
- "GC 是怎么回收对象的？什么时候触发 Full GC？" — [[快手/支付方向/我的快手支付一面]]、[[字节/我的字节一面]]
...
- "类加载机制（JVM 除了字节码解释还能做什么）" — [[快手/支付方向/我的快手支付一面]]、[[其他/银河智学]]
...
## 深入阅读
- 原始专栏 [[专栏/后端/JVM]] —— 教科书版（299 行）
- 真题来源 [[快手/支付方向/我的快手支付一面]]、[[字节/我的字节一面]]、[[蚂蚁/蚂蚁一面]]、[[京东/京东零售一面]]、[[其他/银河智学]]
