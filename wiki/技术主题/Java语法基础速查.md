...
## 高频问法
- "final / finally / finalize 区别" — 后端专栏 [[后端技术专栏/Java语法基础]]
- "String / StringBuffer / StringBuilder 区别；String 为什么不可变" — 后端专栏 [[后端技术专栏/Java语法基础]]
- "重载 vs 重写；哪些方法不能被重写" — 后端专栏 [[后端技术专栏/Java语法基础]]
- "接口 vs 抽象类；jdk8 接口能写什么" — 后端专栏 [[后端技术专栏/Java语法基础]]
- "Java 不支持多继承的原因（菱形继承）" — 后端专栏 [[后端技术专栏/Java语法基础]]
- "HashMap 工作原理（存 / 冲突 / 扩容）" — 后端专栏 [[后端技术专栏/Java集合相关]]
- "单例模式怎么写，为什么 DCL 要 volatile" — [[小鹅通往年面经+我的面经/小鹅通一面面经（带答案已OC）]]
- "生产者消费者模型实现" — 后端专栏 [[后端技术专栏/java参考代码]]
- "函数式接口、Lambda" — 后端专栏 [[后端技术专栏/Java语法基础]]
...
## 深入阅读
- 原始专栏 [[后端技术专栏/Java语法基础]]
- 原始专栏 [[后端技术专栏/Java集合相关]]
- 原始专栏 [[后端技术专栏/java参考代码]]
- [[wiki/技术主题/Java并发集合]]
- [[wiki/技术主题/Java锁体系]]
