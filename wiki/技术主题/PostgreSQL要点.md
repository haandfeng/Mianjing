...
## 高频问法
- "PG 和 MySQL 区别？为什么 PG 复杂查询更强？" — [[字节/我的字节一面]]
- "PG 慢查询怎么排查、优化" — [[蔚来/蔚来一面RAG深挖]]、[[字节/国际商业化/面经记录_国际商业化创业_3.9]]
- "PG 索引种类（B-Tree / Hash / GIN / GiST / BRIN / SP-GiST / Bloom）" — [[蔚来/蔚来一面RAG深挖]]
- "PG 没 binlog 怎么做 CDC / 主从？" — [[阿里云/阿里云消息团队一面面经]]
...
## 深入阅读
- 原始专栏 [[专栏/后端/PgSql]]
- 真题来源 [[字节/我的字节一面]]、[[蔚来/蔚来一面RAG深挖]]、[[阿里云/阿里云消息团队一面面经]]、[[字节/国际商业化/面经记录_国际商业化创业_3.9]]
