...
## 高频问法
- "讲讲你的 RPC 框架（协议字段、请求响应匹配、注册发现）" — [[腾讯/数据平台/我的腾讯一面]]、[[蔚来/蔚来一面RAG深挖]]、[[公司/其他/Cider/1]]
- "请求响应怎么对应？多个请求并发怎么区分" — [[腾讯/数据平台/我的腾讯一面]]、[[蔚来/蔚来一面RAG深挖]]
- "魔数干什么用的；协议识别 vs 帧起始校验" — 后端专栏 [[专栏/后端/RPC框架整理后]]
- "BIO / NIO / AIO 区别" — [[快手/支付方向/快手日常实习面经]]、[[字节/中国商业化/字节跳动中国商业化一面面经]]
- "Netty 为什么快 / 主从 Reactor / 零拷贝" — 后端专栏 [[专栏/后端/Netty]]
- "粘包半包怎么解决；HTTP/1.x / HTTP/2 怎么读边界" — 后端专栏 [[专栏/后端/RPC框架整理后]]
- "Kryo / Protobuf / Hessian / JSON 性能对比" — 后端专栏 [[专栏/后端/RPC框架整理后]]
...
- 原始专栏 [[专栏/后端/RPC框架整理后]]
- 原始专栏 [[专栏/后端/Netty]]
- 真题来源 [[腾讯/数据平台/我的腾讯一面]]、[[蚂蚁/蚂蚁一面]]、[[快手/支付方向/我的快手支付一面]]、[[公司/其他/Cider/1]]、[[蔚来/蔚来一面RAG深挖]]、[[字节/中国商业化/字节跳动中国商业化一面面经]]
