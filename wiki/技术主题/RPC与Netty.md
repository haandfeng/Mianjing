...
## 高频问法
- "讲讲你的 RPC 框架（协议字段、请求响应匹配、注册发现）" — [[腾讯/数据平台/我的腾讯一面]]、[[蔚来/蔚来一面RAG深挖]]、[[Cider面经/1]]
...
- 原始专栏 [[专栏/后端/RPC框架整理后]]
- 原始专栏 [[专栏/后端/Netty]]
- 真题来源 [[腾讯/数据平台/我的腾讯一面]]、[[蚂蚁/蚂蚁一面]]、[[快手/支付方向/我的快手支付一面]]、[[Cider面经/1]]、[[蔚来/蔚来一面RAG深挖]]、[[字节/中国商业化/字节跳动中国商业化一面面经]]
