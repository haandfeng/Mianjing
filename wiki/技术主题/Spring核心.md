...
## 高频问法
- "什么是 IOC？为什么要用？" — 后端专栏 [[后端技术专栏/Spring 相关]]
- "DI 三种注入方式，推荐哪个" — 后端专栏 [[后端技术专栏/Spring 相关]]
- "AOP 是什么、底层原理（JDK 动态代理 vs CGLIB）" — 后端专栏 [[后端技术专栏/Spring 相关]]
- "@Transactional 失效场景；同类方法内调不走代理" — 后端专栏 [[后端技术专栏/Spring 相关]]
- "Bean 作用域 / 生命周期" — 后端专栏 [[后端技术专栏/Spring 相关]]
- "@Autowired vs @Resource" — 后端专栏 [[后端技术专栏/Spring 相关]]
...
## 深入阅读
- 原始专栏 [[后端技术专栏/Spring 相关]]
- 原始专栏 [[后端技术专栏/Spring注解详解]]
- 真题来源 [[字节-今日头条-财经业务/我的字节一面]]、[[小红书/小红书产品工程师一面面经]]
