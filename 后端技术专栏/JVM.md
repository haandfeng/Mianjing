...
> 主题文章：[[JVM内存与GC]]；真题来源：[[快手/支付方向/我的快手支付一面]]、[[字节-今日头条-财经业务/我的字节一面]]、[[京东/京东零售一面]]、[[蚂蚁/蚂蚁一面]]、[[面经较少公司/银河智学]]。
...
- **直接内存**严格说不属于 JVM 规范，但 NIO 的 channel + buffer 大量使用，也是 Netty 性能的来源（[[字节-今日头条-财经业务/我的字节一面]]）。
...
- 真题来源：[[快手/支付方向/我的快手支付一面]]、[[字节-今日头条-财经业务/我的字节一面]]、[[京东/京东零售一面]]、[[蚂蚁/蚂蚁一面]]、[[面经较少公司/银河智学]]
- 项目联动：[[Agent技术专栏/OpenClaw 笔记]]（讲到内存模型时可以类比）
